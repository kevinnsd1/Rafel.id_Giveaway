...
// AlertPenggemar component to confirm if the user wants to leave the page
const AlertPenggemar = ({ message, onConfirm, onCancel }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-brutalism border-2 border-black">
        {/* Display a warning icon for confirmation */}
