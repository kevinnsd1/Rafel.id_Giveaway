  ...
  return (
    <div className="min-h-screen p-4 bg-white flex flex-col items-center">
      ...
      <header className="w-full bg-white shadow-md p-4 flex justify-between items-center top-0 fixed z-50">
        <button
          className="text-2xl"
          onClick={() => navigate("/form-poscode")} // Navigasi ke form-poscode saat tombol arrow ditekan
        >
          ←
        </button>
      ...
      <div className="w-full max-w-lg mt-4">
        <Button
          ...
          onClick={() => navigate("/form-payment")} // Navigasi ke form-payment saat tombol Lanjutkan ditekan
        >
          Lanjutkan
        </Button>
      </div>
