...
import Card from "../../components/Card"; // Mengimpor Card dari folder components
...
export default function GiveawayPage() {
  return (
    <div className="min-h-screen p-4 bg-white flex flex-col items-center">
      ...
      <div className="mt-5">
        {" "}
        {/* Ubah dari my-4 menjadi my-2 untuk mengurangi jarak */}
      ...
      <div className="w-full max-w-md mt-4">
        <Button className="w-full py-2 bg-cyan-400 text-black text-lg font-mono font-bold border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          Cek Giveaway Lain
        </Button>
      </div>
    </div>
